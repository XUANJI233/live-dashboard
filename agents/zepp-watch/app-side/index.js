...
AppSideService(
  BaseSideService({
    ...
    async handleSnapshot(snapshot) {
      ...
      addMetricRecord(records, this.settings, 'sensorSleep', 'sleep_start', metrics.sleep_start, 'minute_of_day', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'sleep_end', metrics.sleep_end, 'minute_of_day', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'sleep_duration', metrics.sleep_duration, 'minutes', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'sleep_stage_count', metrics.sleep_stage_count, 'count', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'nap_start', metrics.nap_start, 'minute_of_day', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'nap_end', metrics.nap_end, 'minute_of_day', recordedAt)
      addMetricRecord(records, this.settings, 'sensorSleep', 'nap_duration', metrics.nap_duration, 'minutes', recordedAt)
      ...
      addMetricRecord(records, this.settings, 'sensorStand', 'stand_count', metrics.stand_count, 'count', recordedAt)
      addMetricRecord(records, this.settings, 'sensorStand', 'stand_target', metrics.stand_target, 'count', recordedAt)
